...
public class IndexModel : PageModel
{
    ...
    public IndexModel(EndUserEventsApiClient eventsApiClient, EndUserSessionService session)
    {
    ...
    public async Task<IActionResult> OnGetAsync(CancellationToken cancellationToken)
    {
        if (!_session.IsSignedIn)
            return RedirectToPage("/Platform/Account/Login", new { returnUrl = "/platform/events" });
