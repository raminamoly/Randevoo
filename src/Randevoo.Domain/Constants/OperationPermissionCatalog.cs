...
public static class OperationPermissionCatalog
{
    ...
    [
        ...
        Permission("notifications", "پیام‌ها", "viewInbox", "مشاهده صندوق پیام‌ها", "مشاهده اعلان‌ها و پیام‌های داخلی.", "support", "پیام‌ها", "/Notifications", "OnGet", "PageAccess", "Low", 1060, planner: true, support: true),
        Permission("notifications", "پیام‌ها", "create", "ارسال پیام", "ثبت پیام داخلی یا پیامک برای گیرندگان مجاز.", "support", "پیام‌ها", "/Notifications/Create", "OnPost", "SensitiveAction", "High", 1070, planner: true, support: true),
        Permission("notifications", "پیام‌ها", "approve", "تایید پیام", "تایید پیام‌های نیازمند بررسی قبل از ارسال.", "support", "پیام‌ها", "/Notifications/Approvals", "OnPostApprove", "SensitiveAction", "High", 1080, support: true),
        Permission("notifications", "پیام‌ها", "reject", "رد پیام", "رد پیام‌های نیازمند بررسی.", "support", "پیام‌ها", "/Notifications/Approvals", "OnPostReject", "SensitiveAction", "High", 1090, support: true),
