...
Needs Verification: no full IIS deployment manifest was confirmed. ASP.NET Core projects can be hosted behind IIS/Kestrel if environment configuration, reverse proxy headers, HTTPS, logging, and secrets are configured.
