...
## Purpose
Show dependency direction and suspicious coupling.
...
- Application depends on Domain abstractions and exposes feature handlers.
- Infrastructure depends on Application and Domain to implement ports, repositories, and EF Core.
- WebApi composes Application and Infrastructure.
- AdminPanel is a separate web UI that calls WebApi using API client services.
